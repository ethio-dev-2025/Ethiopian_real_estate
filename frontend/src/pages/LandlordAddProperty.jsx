    ...
    <div className="max-w-6xl mx-auto">
      <div className="bg-white rounded-xl shadow-sm border overflow-hidden">
        <div className="bg-gradient-to-r from-primary-800 to-primary-900 p-6 text-white">
          ...
          <p className="text-primary-100 mt-1">List your property for rent</p>
        </div>
              ...
              {!showActivation ? (
                <div className="max-w-2xl mx-auto text-center">
                  <div className="bg-white rounded-2xl shadow-xl border p-8">
                    ...
                    <div className="bg-secondary-50 rounded-xl p-4 mb-6 text-left border border-secondary-200">
                      <p className="font-semibold text-secondary-800 mb-2">To activate your landlord account:</p>
                    ...
                    <button onClick={() => setShowActivation(true)} className="px-8 py-3 bg-gradient-to-r from-primary-700 to-primary-800 text-white rounded-xl font-semibold hover:shadow-lg transition-all flex items-center gap-2 mx-auto">
