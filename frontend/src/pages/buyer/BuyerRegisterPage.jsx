...
import { Eye, EyeOff, User, Phone, Lock, UserPlus, ArrowLeft, Home, Heart, CheckCircle } from 'lucide-react';
      ...
      <div className="max-w-md w-full relative z-10">
        <div className="bg-white/10 backdrop-blur-xl rounded-2xl shadow-2xl p-8 border border-white/20">
          <div className="text-center mb-6">
            ...
            <h1 className="text-3xl font-bold text-white mb-2">Join as Buyer</h1>
            <p className="text-gray-300">Create your account to start exploring properties</p>
            <p className="text-xs text-gray-400 mt-2">Use username to login after registration</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input type="text" name="full_name" value={formData.full_name} onChange={handleChange} className={`w-full pl-10 pr-4 py-2.5 bg-white/5 border ${errors.full_name ? 'border-red-500' : 'border-white/10'} rounded-lg text-white placeholder-gray-400 focus:ring-2 focus:ring-teal-500`} placeholder="Enter your full name" />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                <User className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-4 h-4" />
                <input type="text" name="username" value={formData.username} onChange={handleChange} className={`w-full pl-10 pr-4 py-2.5 bg-white/5 border ${errors.username ? 'border-red-500' : 'border-white/10'} rounded-lg text-white placeholder-gray-400 focus:ring-2 focus:ring-teal-500`} placeholder="Choose a username (used for login)" />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="tel" name="phone" value={formData.phone} onChange={handleChange} className="w-full pl-10 pr-4 py-2.5 bg-white/5 border border-white/10 rounded-lg text-white placeholder-gray-400 focus:ring-2 focus:ring-teal-500" placeholder="Enter your phone number" />
              </div>
            </div>
            ...
            <button type="submit" disabled={loading} className="w-full py-3 bg-gradient-to-r from-teal-600 to-emerald-600 rounded-xl font-semibold text-white hover:shadow-lg transition-all disabled:opacity-50 flex items-center justify-center gap-2 mt-2">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-300">
              ...
              <Link to="/buyer/login" className="text-teal-400 hover:text-teal-300 font-semibold transition">Sign In</Link>
            </p>
          </div>
        </div>
      </div>
