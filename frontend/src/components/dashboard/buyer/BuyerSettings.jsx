      ...
      <div className="bg-white rounded-2xl shadow-sm border overflow-hidden">
        ...
        <div className="p-6 bg-gray-50">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm text-gray-500">Account created as Buyer / Renter</span>
          </div>
        </div>
        ...
        <div className="p-6 border-t">
          ...
          <p className="text-sm text-gray-600">You are registered as a <span className="font-semibold">Buyer</span>. You can browse properties, save favorites, and contact sellers.</p>
        </div>
      </div>
    </div>
  )
